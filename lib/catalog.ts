...
const groups: Record<string, { old: string; rows: Row[] }> = {
 ...
 ["brunnar-betackningar","Brunnar och betäckningar","Brunnar, stigarrör och lock för mark och gård.",["Wavin-system med botten, rör, teleskopsrör, packning och lock med handtag.","Stigarrör 400 mm med botten samt förhöjningsringar i plast.","Järnbetäckningar 150, 225, 300 och 400 mm i tätt och silat utförande.","Spygatt med sido- eller bottenutlopp, golvbrunnar och serviceplatta.","Ange brunnsdiameter och djup när du hör av dig."]],
 ["rannor-galler","Rännor och galler","Linjeavvattning för uppfart, garageinfart och entré.",["ACO Self ränna 1 m och halvränna 0,5 m, med utlopp i botten eller gavel.","Spaltgaller varmförzinkat, täta gavlar och tillvalssats.","Ränndalsplattor och tillbehör för anslutning mot brunn.","Berätta hur lång sträcka du ska avvattna så räknar vi ihop delarna."]],
